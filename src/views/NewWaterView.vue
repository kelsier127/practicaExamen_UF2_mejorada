...
<template>
  <h2 class="title">New water view</h2>
  <ul>
    <li v-for="(nom,index) in embassaments" :key="index">
      <RouterLink class="bobi btn btn-primary" :to="`/water2/${nom}`"> Embassament Nº {{ index+1 }}: {{ nom }} </RouterLink>
    </li>
  </ul>
</template>
